...
def main():
    ...
    root = '/media/tao/A3D8-E2F7/Video_frames/'
    ...
    #     # print train_loader(700)
    #     print i
    #     if i == 5605:
    #         print input,target
    #         inp = input[0].numpy()
    #         targ = target[0][0].numpy()
    #         print inp.transpose(1,2,0).shape,targ.shape
    #         inpp = inp.transpose(1,2,0)
    #
    #         print inpp.max(), targ.max()
    #         print(inpp[inpp>1])
    #         plt.imshow(targ)
    #         plt.show()
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        if (i+1) % 1000 == 0:
            ...
            print(msg)
        # if i+1==5605:
        #     # print losses,loss,loss.data[0], target.size(0)
        #     print input_var.size(),target_var.size()
        #     # print input,target
        #     print input_var,target_var
        #
        #     inp = input[0].cpu().numpy()
        #     targ = target[0][0].cpu().numpy()
        #     print inp.transpose(1,2,0).shape,targ.shape
        #     inpp = inp.transpose(1,2,0)
        #
        #     print inpp.max(), targ.max()
